 ...
 * {@link ClasificacionFragment.OnFragmentInteractionListener} interface
...
public class ClasificacionFragment extends Fragment {
    ...
    public static ClasificacionFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        miAdapter = new PartidasAdapter(clasificacion, LayoutInflater.from(getActivity()));
